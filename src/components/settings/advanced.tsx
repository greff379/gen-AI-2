  ...
  return (
    <>
      <DialogHeader>
        ...
        <DialogDescription>
          Add some useful features to New AI.
        </DialogDescription>
      </DialogHeader>
                          ...
                          <div className="flex flex-1 items-center">
                            <div className="text-sm w-full">
                              ...
                              >
                                ...
                                <Textarea placeholder="Leave blank for original version New AI" onChange={(event) => handleChangePrompt(event.target.value)} value={systemPrompt || prompt.content} /> : <span>{prompt.desc}</span>
                                }
                              </RadioGroup.Description>
                            </div>
                          </div>
